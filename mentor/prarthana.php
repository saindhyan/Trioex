...
<head>
 ...
 <?php include '../includes/header.php'?> 
    ...
    <div class="container-fluid"> 
        <div class="main">
          <div class="headerdiv">
            <h1 class="text-center text-primary btn-block">Prarthana Borah<sub class="subtop">~India Director of Clean Air Asia</sub> </h1> 
          ...
          <div class="contant">
               <div class="row">
                 ...
                 <div class="col-md-4"> <img  class="mimg text-center"  src="image/prarthnaborah.jpg">     </div>
                <div class="col-md-8m">
           <p>
        <h4 class="headings">Highlights</h4>
                 ...
                 <div class="details">
                    <ul>
                        <li>
                            Environmental Sustainability Strategist with more than 20 years experience
                        </li>
                        <br>
                       <li>
                        Working with the UNICEF to prepare an air quality advocacy</li>
                       <br>
                       <li>SPECIALTIES: Conservation Education, Sustainability Strategy, Environment Policy, Climate and Air Quality Management</li>
                       <br></ul>
</div>
                  <div>
                    ...
                    <div class="details"><ul><li>
                      <p class="mentor-body">
                        Experienced Country Head with ten plus years of years in leading India country programs of two global not for profits and one national institute. 
                        Twenty-five years of experience in strategic planning and program leadership. </p></li><br>
                     <li> <p class="mentor-body">She's a sector expert in Air Quality and Climate Change, Biodiversity Conservation and Education for Sustainable Development. Result-oriented facilitator of partnerships on environmental/ development issues between and with governments, donors, civil society, private sector to influence policy and action</p></li> <br>
                <li><p class="mentor-body"> She was the Team Lead at the Centre for Environment Education, India where she was involved in high level policy document preparation. She led the team for preparation of Government of India’s policy documents for COP21 in Paris and for the negotiation of the SDGs by Government of India at United Nations.</p></li><br>
                <li><p class="mentor-body"> Prarthana was also involved in education for sustainable development (ESD) for children and youth in different regions of India including the Indian Ministry of Environment and Forests’ first Climate Change Education programme, a project that is recognized by UNESCO as ESD best practice. </p></li><br>
            </ul></div></div>
