...
<head>
 ...
 <?php include '../includes/header.php'?> 
    ...
    <div class="container-fluid"> 
        <div class="main">
          <div class="headerdiv">
            <h1 class="text-center text-primary btn-block"> Rohit Singh <sub class="subtop">~Co-Founder & VP- Engineering at 360 logica </sub> </h1> 
          ...
          <div class="contant">
               <div class="row">
                 ...
                 <div class="col-md-4"> <img  class="mimg text-center"  src="image/Rohit-Singh-Im.gif">          </div>
                <div class="col-md-8m">
           <p>
        <h4 class="headings">Highlights</h4>
                 ...
                 <div class="details">
                    <ul>
                        <li>20+ YEARS OF PRIVATE EQUITY, CORPORATE FINANCE AND FINANCE OPERATIONS EXPERIENCE ACROSS INDIA AND SOUTH EAST ASIA
                        </li>
                        <br>
                       <li>Award and Recognition: Deloitte Fast 50 Award</li>
                       <br>
                       <li>SPECIALTIES: QA, software testing, Outsourcing, Offshore, Manual testing, Automation, Black Box, White Box testing, bugs, error, database, System Integration testing, BETA, UAT, Test cases design, Test Planning and Test Management, QA outsourcing, Accessibility Testing, IOT, DevOps</li>
                       <br></ul>
</div>
                  <div>
                    ...
                    <div class="details"><ul><li>
                      <p class="mentor-body">
                        Rohit has institutionalized a simple, yet strong philosophy of 3P - Planning, Prioritization and Process' in the organization, which assists him to strategically think and allocate tasks in critical situations.</p></li> <br>
                   <li> <p class="mentor-body">Rohit is the proud owner of 200 people strong organization which has been listed 11th in the Fastest 50 Technology Companies (Deloitte-2013) and is also a part of the eminent listing of Red Herring for Top 100 Asia (2014). Under a robust headship of the consistent and focused technical expert, the company has grown profoundly to possess the envious distinction of hosting 100+ software product companies& ISVs with QA/Testing services as its clientele.</p></li> <br>
                <li><p class="mentor-body">Rohit defines a role model as a person who guides people to learn and amongst many such role models.He is greatly thankful to his family, teacher and his colleagues, who led him to grow as an individual that he is today.</p></li><br>
            </ul></div></div>
