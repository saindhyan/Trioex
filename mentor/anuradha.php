...
<head>
 ...
 <?php include '../includes/header.php'?> 
    ...
    <div class="container-fluid"> 
        <div class="main">
          <div class="headerdiv">
            <h1 class="text-center text-primary btn-block"> Anuradha Chadha <sub class="subtop">~Founder & CEO at 3A Clothing </sub> </h1> 
          ...
          <div class="contant">
               <div class="row">
                 ...
                 <div class="col-md-4"> <img  class="mimg text-center"  src="image/anuradha-chadha-1.jpg">          </div>
                <div class="col-md-8m">
           <p>
        <h4 class="headings">Highlights</h4>
             </p>
                 <div class="details">
                    <ul>
                        <li>Cofounder and Chief Fashion Officer at DAZL</li>
                        <br>
                        <li>Specialties: In-depth experience in design, marketing, business development, manufacturing of textiles and fashion accessories, finance, documentation, regulatory compliancies, negotiation of international legal contracts , Sustainability in supply chain .</li>
                        <br>
                        <li>Anuradha is the winner of the prestigious:- <br>
                            Udyog Rattan Award for her business leadership in 2006 <br>
                           She is an IWAC awardee 2016 from Ficci Flo and US chamber of commerce ,(woman entrepreneurship ) <br>
                           WIEF awardee 2017 at Kuching, Malayasia ,(woman entrepreneurship) <br>
                           Walmart wedp speaker at Amity institute 2017 , <br>
                            MIT Boston panelist and speaker for Bridge Asia Feb 2020 , <br>
                           Star nfluencer of the year 20-21 in textiles at womannovator . <br>
                           Anu has won mention in a leading Swedish magazine as the Asian Woman Entrepreneur. 
                        </li>
                        <br>
                      </ul>
</div>
                  <div>
                    <h4 class="headings">Professional Career</h4>
                    <div class="details"><ul><li>
                      <p class="mentor-body">
                        Under Anu’s leadership, 3A Clothing successfully competes in the international fashion export industry exporting to Europe and USA, by focusing on price effectiveness, optimum resource-utilization, quality and timely deliveries. Through her entrepreneurial vision, Anu has made a global impact on the business of fashion and style.</p></li><br>
                     <li> <p class="mentor-body">Anu brings more than 25 years of in-depth experience in the international fashion industry and trend forecasting, and has established a successful fashion export house selling to renowned international retail chains. The Company employs a large number of women who are sole breadwinners in their homes, and are able to provide a stable environment for their families as well as educate their children. </p></li> <br>
                <li><p class="mentor-body">Through her entrepreneurial vision, Anu has made a global impact on the business of fashion and style. </p></li><br>
           <li><p class="mentor-body"> She is a guest lecturer at the KEA School of Design and Technology in Denmark and is a frequent speaker at the Indian Institute of Corporate Affairs affiliated with the Ministry of Corporate Affairs, Government of India. </li></ul><br>
            </p></div></div>
