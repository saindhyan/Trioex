...
<head>
 ...
 <?php include '../includes/header.php'?> 
    ...
    <div class="container-fluid"> 
        <div class="main">
          <div class="headerdiv">
            <h1 class="text-center text-primary btn-block"> Gaurav Singh<sub class="subtop">~Founder & Chief Executive Officer at Verloop </sub> </h1> 
          ...
          <div class="contant">
               <div class="row">
                 ...
                 <div class="col-md-4"> <img  class="mimg text-center"  src="image/gaurav-singh_founder-ceo_verloop.jpg">          </div>
                <div class="col-md-8m">
           <p>
        <h4 class="headings">Highlights</h4>
                 ...
                 <div class="details">
                    <ul>
                        <li> Co-founded GoDeliver which got acquired by MagicTiger.
                        </li>
                        <br>
                       <li>Member of Forber Technology Council</li>
                       <br>
                       <li>SPECIALTIES: JavaScript Expert, Master of Web Technology Stack</li>
                       <br></ul>
</div>
                  <div>
                    ...
                    <div class="details"><ul><li>
                      <p class="mentor-body">
                        He is founder of Verloop.io, the world's leading customer support automation platform. It helps businesses deliver delightful support experiences to their customers, across channels. Used by unicorns and Fortune 500 companies across India, SEA, MENA and the Americas.</p></li> <br>
                   <li> <p class="mentor-body">He has experience work covered by Discovery, CBS, TechRadar and Github trending.</p></li> <br>
                <li><p class="mentor-body">He has been on the founding team of ventures like ‘Stalk Ninja’ and ‘GoDeliver’. Gaurav worked with TCS, LT Research, and Vizury before starting Verloop.</p></li><br>
           </ul></div></div>
