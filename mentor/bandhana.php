...
<head>
 ...
 <?php include '../includes/header.php'?> 
    ...
    <div class="container-fluid"> 
        <div class="main">
          <div class="headerdiv">
            <h1 class="text-center text-primary btn-block"> Bandhana Katoch<sub class="subtop">~Business Advisor at College of the Canyons </sub> </h1> 
          ...
          <div class="contant">
               <div class="row">
                 ...
                 <div class="col-md-4"> <img  class="mimg text-center"  src="image/Bandhana-Katoch.jpg">     </div>
                <div class="col-md-8m">
           <p>
        <h4 class="headings">Highlights</h4>
                 ...
                 <div class="details">
                    <ul>
                        <li>
                            Co-Founder & Founding Trustee at Samya Foundation
                        </li>
                        <br>
                       <li>
                        Social Impact Global FellowSocial Impact Global Fellow at
                        MovingWorlds Institute  </li>
                       <br>
                       <li>SPECIALTIES: Science Enthusiast, Sustainable Ecosystems,  Agriculture & Food, Biotechnology, Life Sciences</li>
                       <br></ul>
</div>
                  <div>
                    ...
                    <div class="details"><ul><li>
                      <p class="mentor-body">
                        Highly self-motivated business professional with 20+ years of work experience conducting prior art search, technology assessment, market assessment and freedom-to-operate analysis for medical and life sciences technologies. </p></li> <br>
                   <li> <p class="mentor-body">Proficient in providing professional advice on areas related to the business plan, SWOT analysis, investor pitches, licensing models, business planning and strategies related to management, operations, human resources. </p></li> <br>
                <li><p class="mentor-body"> She has been involved in developing an entrepreneurial ecosystem through technology and social innovation with the mission of self-sustainability and social impact.</p></li><br>
            </ul></div></div>
