...
<head>
 ...
 <?php include '../includes/header.php'?> 
    ...
    <div class="container-fluid"> 
        <div class="main">
          <div class="headerdiv">
            <h1 class="text-center text-primary btn-block"> Amit Manocha <sub class="subtop">~Finance professional with strong Analytical skills </sub> </h1> 
          ...
          <div class="contant">
               <div class="row">
                 ...
                 <div class="col-md-4"> <img  class="mimg text-center"  src="image/amit_manocha.jpg">          </div>
                <div class="col-md-8m">
           <p>
        <h4 class="headings">Highlights</h4>
                 ...
                 <div class="details">
                    <ul>
                       ...
                       <br>
                       <li>SPECIALTIES: PRIVATE EQUITY, M&A, INVESTMENTS, BUY OUTS, FINANCIAL PLANNING & ANALYSIS, FINANCIAL REPORTING AND MIS, CORPORATE FINANCE ACCOUNTING, TREASURY AND CREDIT CONTROL, COMMERCIAL, CORPORATE GOVERNANCE</li>
                       <br></ul>
</div>
                  <div>
                    ...
                    <div class="details"><ul><li>
                      <p class="mentor-body">
                        Amit Manocha heads The Investment Office (TIO), which is responsible for monitoring all investments and exit processes within Everstone’s private equity group.</p></li> <br>
                   <li> <p class="mentor-body">He has over 20 Years of Private Equity, Corporate Finance and Finance Operations experience across India and South East Asia, which saw him in roles with CocaCola, GE Capital, and HCL Technologies</p></li> <br>
                <li><p class="mentor-body">Manocha is highly operations focused and hands-on approach to monitoring of portfolio companies, including de-facto CFO responsibilities in few buy-outs</p></li><br>
            <li><p class="mentor-body">Amit holds a Bachelor of Commerce from the University of Delhi and is an alumnus of Harvard Business School. He is also a qualified Chartered Accountant. </li> <br>
            </p></ul></div></div>
