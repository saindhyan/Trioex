...
<head>
 ...
 <?php include '../includes/header.php'?> 
    ...
    <div class="container-fluid"> 
        <div class="main">
          <div class="headerdiv">
            <h1 class="text-center text-primary btn-block"> Anirudh Suri <sub class="subtop">~Venture capitalist, technology entrepreneur and policy advisor </sub> </h1> 
          ...
          <div class="contant">
               <div class="row">
                 ...
                 <div class="col-md-4"> <img  class="mimg text-center"  src="image/anirudh-headshot-alt.jpg">          </div>
                <div class="col-md-8m">
           <p>
        <h4 class="headings">Highlights</h4>
                 ...
                 <div class="details">
                    <ul>
                        <li>Education:- <br>
                            MBA, The Wharton School, University of Pennsylvania <br>
                            MPA, Harvard Kennedy School <br>
                            BA, Economics and Politics, Haverford College
                        </li>
                        <br>
                       <li>HANDS-ON APPROACH TO MONITORING OF PORTFOLIO COMPANIES, INCLUDING DE-FACTO CFO RESPONSIBILITIES IN FEW BUY-OUTS </li>
                       <br>
                       <li>SPECIALTIES: Interests lie at the intersection of technology and geopolitics, climate, and strategic affairs</li>
                       <br></ul>
</div>
                  <div>
                    <h4 class="headings">Professional Career</h4>
                    <div class="details"><ul>
                     <li><p class="mentor-body">
                        Anirudh Suri is a nonresident scholar with Carnegie India. His interests lie at the intersection of technology and geopolitics, climate, and strategic affairs. He is currently exploring how India is carving and cementing its role in the global tech ecosystem and the role climate technology can play in addressing the global climate challenge.</p></li><br>
                  <li> <p class="mentor-body">He is the author of The Great Tech Game: Shaping Geopolitics and the Destinies of Nations (HarperCollins, 2022) and is currently the managing partner at India Internet Fund, a technology-focused venture capital fund based in India and the United States. He has also written extensively on foreign policy, geopolitics, cybersecurity, climate, technology, and entrepreneurship in publications such as the Indian Express, Times of India, Hindustan Times, Foreign Policy, the Print, the New Republic, Economic Times, MoneyControl, and Asia Times. </p> </li><br>
               <li> <p class="mentor-body">Previously, he has worked with the government of India in New Delhi, McKinsey and Company in New York, Goldman Sachs in London, and China Institute of International Studies in Beijing.  </p></li><br>
            <li><p class="mentor-body"> He completed his MBA from the Wharton School at the University of Pennsylvania, his MPA from the Harvard Kennedy School, and holds a bachelor's degree in economics and political science from Haverford College, Pennsylvania. He has also studied Mandarin Chinese at the Beijing Foreign Studies University. Named a Goldman Sachs Global Leader, he has also served on the board of the Harvard Alumni Association. <br>
            </p></li></div></div>
        </ul>
       </div>
                 </div>
