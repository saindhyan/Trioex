...
<body>
        ...
        <div class="title-text">
            ...
            <div class="form-inner">
                ...
                <form  onsubmit = "return Validation()" name = "RegForm" class="signup" method = "post">
                    <div class="field">
                        <input type="text" name = "Fname" placeholder="Government Agency" required>
                    </div>
                    ...
                    <div class="field">
                    <input type="text" name = "type" placeholder="Type of industry" required>
                    </div>
    ...
    <?php
                    ...
                    if(isset($_POST['sub']))
                    {
                       ...
                       $query=mysqli_query($conn,"SELECT * FROM govt_signup where Email = '$email'");
                       ...
                       if(mysqli_num_rows($query)>0){
                           ...
                           $sql = "insert into govt_signup(Agency, Email, Type, Password) values('$Fname','$email','$type', '$pass')";
                       ...
                       if($result === true){
                           ...
                           window.location.href='register problem statement/index.php';
