...
<html lang="en">
   <head>
      ...
      <title>TrioEX   | Incubation Centers
      </title>
      <!-- SEO Meta Tags-->
      <meta name="description" content="TrioEx | Home Page">
      <meta name="keywords" content="">
      <meta name="author" content="TrioEx">
     <meta name="csrf-token" content="3MCQfkudMSZLiSRTF98SWXnR0rchrl5dXygMqZF6">
      <!-- Viewport-->
...
<body>
  ...
  <div class="d-flex align-items-center order-lg-3 ml-lg-auto">
    ...
    <a class="btn btn-dark ml-grid-gutter d-none d-lg-inline-block" href="signup.html">Sign up</a>
      ...
      <li class="nav-item active"><a class="nav-link" href="iic.html" >incubation Centers</a>
              </li>
