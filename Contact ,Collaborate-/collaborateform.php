      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7 py-5">
            <h3>Collaborate Form :</h3>
            <form action="allob.php" method="post">
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group first">
                    ...
                    <input type="number" name="comp" class="form-control"  id="lname">
                  </div>    
                </div>
                  <div class="form-group first">
                  ...
                  <div class="form-group first">
                    <input type="checkbox"  name="first" id="lname">
                    <label class=" checkin" for="SME">SME</label>
                    <input type="checkbox" name="second" id="lname">
                    <label class=" checkin" for="MSME">MSME</label>
                    <br>
                    <input type="checkbox" name="third" id="lname">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group first">
                    ...
                    <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="email" class="form-control"  id="email">
                  </div>    
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group first">
                    ...
                    <input type="text" name="website" class="form-control"  id="lname">
                  </div>    
                  
                 
                  <br>
                  <label for="lname">Reason To Collaborate</label>
