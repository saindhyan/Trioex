...
if(isset($_POST['submit']))
{
    ...
    $d=$_SERVER['DOCUMENT_ROOT']."/trioex/success stories/success stories/Upload/".$_POST['Sname'].".jpg";
    $img="";
    ...
    $insert="insert into register_startup values('$_POST[Sn]','$_POST[Sname]','$_POST[lname]','$_POST[lrole]',$_POST[Tsize],$_POST[Csize],'$_POST[TypeC]','$_POST[Address]','$_POST[Domain]','$_POST[about]','$_POST[vision]','$_POST[funding]','$_POST[valuation]','$_POST[email]','$_POST[phone]','$_POST[website]','$img')";
    echo $insert;
