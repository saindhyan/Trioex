...
<head>
    ...
    <title>TriOex | Problem Statements</title>
            ...
            <div class="cs-offcanvas-collapse order-lg-2" id="primaryMenu">
              ...
              <div class="cs-offcanvas-body">
                ...
                <ul class="navbar-nav">
				  ...
				  <li class="nav-item"><a class="nav-link" href="startup.php" >Startup</a>
				  ...
				  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle"  data-toggle="dropdown">More</a>
                    <ul class="dropdown-menu">
						<li><a class="dropdown-item active" href="problem_statement.php">Problem Statements</a></li>
...
<div style="background-image: url(/image/header-bg.svg); margin-top: 3%;" >

    <h1 class="problem-statement" style="padding-top: 5%; padding-bottom:5%;"><strong>Problem Statement</strong></h1>
  </div>
    <table class="containert">
        <thead>
            <tr>
                <th><h1>S.No.</h1></th>
                <th><h1>Organization</h1></th>
                <th><h1>Problem Statement Title</h1></th>
                <th><h1>Category</h1></th>
                <th><h1>PS No.</h1></th>
                <th><h1>Domain/Bucket</h1></th>
                <th><h1>Submit Your Idea</h1></th>
            </tr>
        </thead>
      <tbody>  
...
<?php   
      ...
      $result = $conn->query($sql);
       while ($row = $result->fetch_assoc()) {
          echo "<tr>
            <td id='sno'>".$row['S.No.']."</td>
            <td style='text-align: center'>".$row['Organization']."</td>
            <td style='text-align: center'>".$row['PST']."</td>
            <td>".$row['Category']."</td>
            <td>".$row['PS_No.']."</td>
            <td>".$row['Domain/Bucket']."</td>
            <td></td>
        </tr>";
       }
      ?>  
