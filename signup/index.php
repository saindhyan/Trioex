    ...
    <div class="wrapper">
        ...
        <div class="form-container">
            ...
            <div class="form-inner">
                ...
                <form action="signup.php" onsubmit = "return Validation()" name = "RegForm" class="signup" method = "post">
                    <div class="field">
                    ...
                    <div class="field">
                        <select id="course_select" name="role" class="fo" required="" style="width: 100%;height: 100%;">
