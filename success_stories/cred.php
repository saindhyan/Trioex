...
<?php include '../includes/header.php'?> 
    ...
    <script src="https://kit.fontawesome.com/a986795f59.js" crossorigin="anonymous"></script>
...
<link rel="stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" href="/asset/css/ss2.css">


    <!-- Google Fonts -->
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@100&family=Oswald:wght@500&family=Ubuntu:wght@300&display=swap" rel="stylesheet">


<header class="post-header">
  <h1 class="post-title">Physics Wallah</h1>
</header>
	

	  <div class="post-body">

		<img class="startup-logo" src="https://upload.wikimedia.org/wikipedia/commons/9/9d/CRED-LOGO2.png" alt="">

		<p class="post-lede">CRED allows credit card users to pay their credit card bills through its platform and extends rewards for each transaction.</p>
	  
		<p>The goal was very simple. It was to create a platform where life could be made better and systematic. Kunal Shah wanted to offer more privileges and benefits to the people having good credit scores. And therefore, creating a flywheel effect for more people was important to improve the scores.</p>
	  
		<p>Cred has raised a total amount of $1+ billion in funding over the 10 funding rounds that the brand has witnessed. Cred has last received $80 mn in funding on June 9, 2022, via its Series F funding round led by GIC, and followed by Sofina Ventures, Alpha Wave Ventures, and DF International.</p>
	  
		<h1 class="alakh">Kunal Shah(Founder's Corner)</h1>
		<p>Kunal started his entrepreneurial journey with PaisaBack, a website for cashback, coupons, and other offers for the users along with Sandeep Tandon. However, he eventually shut down its operations in order to found FreeCharge, which the duo founded in 2010.</p>
	  
		<p>Cred has shown steady growth throughout the years. Being a startup that was founded in 2018, it successfully joined the unicorn club on April 6, 2021, closing its Series D round where the company had mopped up $215 million. Cred controls "22% of all credit card payments in India on a monthly basis,” said Kunal Shah in his statement released in April 2021. Cred's valuation reached $6.5 billion in 2022 after a $200 million funding round.</p>
	  </div>
